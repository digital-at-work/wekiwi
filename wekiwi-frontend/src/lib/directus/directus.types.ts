//!!CUSTOM TYPES!! HAVE TO BE COPY PASTED INTO THE DIRECTUS TYPES FILE --->
export type PartialContents = PartialContent[]

export type PartialUser = Pick<DirectusUsers, 'username' | 'avatar' | 'first_name' | 'last_name' >;

export type PartialContent = {
  child_id?: null | any[] | PartialContent[];
  content_id?: number;
  content_type?: string;
  content_url?: string | null;
  date_created?: string | null;
  date_updated?: string | null;
  parent_id?: number | PartialContent | null;
  summary?: string | null;
  text?: string | null;
  title?: string | null;
  user_created?: PartialUser | null;
  user_updated?: PartialUser | null;
...
export type Company = {
  ...
  whitelabel_titel?: string | null;
};

export type CircleContents = {
  circle_id?: number | Circles | null;
  content_id?: number | Contents | null;
  id: number;
};

export type Circles = {
  circle_avatar?: string | DirectusFiles | null;
  circle_id: number;
  circle_name: string;
  date_created?: string | null;
  date_updated?: string | null;
...
export type Contents = {
  child_id: null | any[] | Contents[];
  circle_contents: any[] | CircleContents[];
  company_id?: number | Company | null;
  content_id: number;
  content_type: string;
  content_url?: string | null;
  date_created?: string | null;
  date_updated?: string | null;
  parent_id?: number | Contents | null;
  sort?: number | null;
  status: string;
  summary?: string | null;
  text?: string | null;
  title?: string | null;
  user_created?: DirectusUsers | null;
...
export type DirectusUsers = {
  ...
  title?: string | null;
  token?: string | null;
  user_circles?: any[] | UserCircle[];
  username?: string;
  user_folder: null | DirectusFolders;
};
...
export type Interactions = {
  ...
  interaction_duration?: string | null;
...
export type CustomDirectusTypes = {
  circle_contents: CircleContents[];
  circles: Circles[];
  contents: Contents[];
  company: Company[];
